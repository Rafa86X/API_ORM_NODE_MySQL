...
async function getAllComandasService (data){
    ...
    }while(t<comandexSemVazios.length);
    return objComanda;    
...
module.exports = { getAllComandasService }; 